...
| Layer | State |
|---|---|
| Engine math (BPM, time sig, subdivision, accents, count-in, scheduling) | ✓ Built — 345 tests passing, drift < 1 ms/min verified in math |
